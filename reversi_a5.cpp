...
int main() {
	...
	// generate board
	// find valid spaces and add to board
	// display board
	// prompt for move from player
	// move piece is added
	// board is updated (pieces are flipped where appropriate)
	// board is cleaned

	// find valid spaces //and add to board (not neccesary)
	// computer makes move
	// move piece is added
	// board is updated (pieces are flipped where appropriate)
	// board is cleaned
	
	// repeat until both players skip

	// prompt to reset game or quit
	// if reset. reset all parameters and go back to beginning of big while loop
	// if quit. exit

	// scan for valid moves [black]
	// scan cell by cell looking for white piece
	// check all 8 squares next to it ...
	// if square empty, check all 8 directions
	// if move found break
	// else move on to next white piece
	// ***valid move determined by whether white piece is in next square
	// if yes, whether a black, white, empty, or end square is in next square
	// if black, break and valid
	// if white keep searching
	// if empty break and not valid
	// if end break and not valid

	// for white do opposite